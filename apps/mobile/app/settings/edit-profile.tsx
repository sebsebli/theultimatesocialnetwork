...
export default function EditProfileScreen() {
  ...
  const [avatarActionSheetVisible, setAvatarActionSheetVisible] =
    useState(false);
  ...
  const avatarOptions = [
    {
      label: t("settings.takePhoto", "Take photo"),
      onPress: () => closeAvatarSheetAndThen(() => pickImage("camera")),
      icon: "camera-alt" as const,
    },
    {
      label: t("settings.choosePhoto", "Choose from library"),
      onPress: () => closeAvatarSheetAndThen(() => pickImage("library")),
      icon: "photo-library" as const,
    },
    ...(avatarKey || avatarUrl || avatarLocalUri
      ? [
          {
            label: t("settings.removePhoto", "Remove photo"),
            onPress: () => closeAvatarSheetAndThen(removeAvatar),
  ...
  const pickImage = async (source: "camera" | "library") => {
    try {
      ...
      if (!permission.granted) {
        showError(
          t(
            "settings.photoPermissionDenied",
          ...
          <View style={styles.form}>
            ...
            >
              ...
              <Text style={styles.avatarHint}>
                {t("settings.tapToChangePhoto", "Tap to change photo")}
              </Text>
            </Pressable>
            ...
            >
              ...
              <View style={[styles.switch, isProtected && styles.switchActive]}>
                <View
                  style={[styles.thumb, isProtected && styles.thumbActive]}
                />
              </View>
            </Pressable>
          </View>
