    ...
    <div className="min-h-screen bg-[#0B0B0C] text-[#F2F2F2]">
      ...
      <main className="max-w-[800px] mx-auto pt-32 pb-20 px-6">
        <header className="mb-16">
          <h1 className="text-4xl md:text-5xl font-serif font-normal text-[#F2F2F2] mb-6">
            Open Roadmap
          </h1>
          <p className="text-xl text-[#A8A8AA] font-light leading-relaxed">
            We build in public. This is what we are working on, what is coming
            next, and where we need your help.
          </p>
        </header>
        ...
        <div className="space-y-16">
          ...
          <article>
            <div className="flex items-baseline gap-4 mb-8 border-b border-[#1A1A1D] pb-2">
              <h2 className="text-xl font-serif text-[#F2F2F2]">
                Shipping Now
              </h2>
            ...
            <ul className="space-y-6">
              <li className="group">
                <h3 className="text-lg font-medium text-[#F2F2F2] mb-2 group-hover:text-[#6E7A8A] transition-colors">
                  Native Mobile Apps
                </h3>
                <p className="text-[#A8A8AA]">
                  iOS and Android apps are live. Offline-first architecture for
                  reporting from the field. Biometric security included.
                </p>
              </li>
              <li className="group">
                <h3 className="text-lg font-medium text-[#F2F2F2] mb-2 group-hover:text-[#6E7A8A] transition-colors">
                ...
                <p className="text-[#A8A8AA]">
                  Basic posting, replying, and the native citation graph
                  structure. Inline wikilinks are fully functional.
                </p>
              </li>
              <li className="group">
                <h3 className="text-lg font-medium text-[#F2F2F2] mb-2 group-hover:text-[#6E7A8A] transition-colors">
                ...
                <p className="text-[#A8A8AA]">
                  Like counts are visible only to the author. No public
                  popularity contests.
                </p>
              </li>
              <li className="group">
                ...
                <p className="text-[#A8A8AA]">
                  Every public profile has an RSS feed. Your content is portable
                  and open.
                </p>
              </li>
            </ul>
            ...
            <ul className="space-y-6">
              <li className="group">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full bg-[#1A1A1D] border border-[#333] text-[10px] text-[#A8A8AA] font-mono uppercase">
                    Backend
                  </span>
                </div>
                <p className="text-[#A8A8AA]">
                  Automatic snapshotting of all cited external links via the
                  Internet Archive. Context should never 404.
                </p>
              </li>
              <li className="group">
                ...
                <p className="text-[#A8A8AA]">
                  Collaborative collections for recipes, research, and reading
                  lists. Share privately or publicly.
                </p>
              </li>
            </ul>
          </article>
          ...
          <article>
            <div className="flex items-baseline gap-4 mb-8 border-b border-[#1A1A1D] pb-2">
              <h2 className="text-xl font-serif text-[#A8A8AA]">
                Future Concepts
              </h2>
              <span className="text-xs font-mono text-[#6E6E73] uppercase tracking-widest">
                Research
            ...
            <ul className="space-y-6 opacity-80">
              <li>
                <h3 className="text-lg font-medium text-[#A8A8AA] mb-2">
                  Federation
                </h3>
                <p className="text-[#6E6E73]">
                  Exploring ActivityPub compatibility to connect with Mastodon
                  and the Fediverse.
                </p>
              </li>
            </ul>
