        ...
        <div className="prose prose-invert prose-p:text-[#A8A8AA] prose-headings:text-[#F2F2F2] prose-headings:font-medium prose-a:text-[#F2F2F2] prose-strong:text-[#F2F2F2] max-w-none font-serif leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <p>
              ...
              and services operated by <strong>Dr. Sebastian Lindner</strong>{" "}
              (“Operator”, “we”, “us”), accessible via the domain{" "}
              <strong>citewalk.com</strong> and the associated mobile
              applications (“Service”).
            </p>
            <p>
              By accessing or using the Service, you enter into a legally
              binding agreement pursuant to §§ 145 ff. BGB. You confirm that you
              are at least 16 years of age.
            </p>
            <p>
              The Service is operated as a personal initiative by the Operator
              and is not affiliated with any corporation or external company at
              this time.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p>
              ...
              post, or transmit. The Operator acts solely as a hosting provider
              within the meaning of Art. 6 Digital Services Act (DSA).
            </p>
            <p>
            ...
            <p>
              ...
              a <strong>permanent ban</strong> of your account. Enforcement is
          ...
          <section className="mb-12">
            ...
            <p>
              ...
              be stored and processed in unencrypted or transport-encrypted
              form.
            </p>
            <p>
