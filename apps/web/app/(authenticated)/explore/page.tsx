      ...
      <div className="pt-1 pb-3 sticky top-[72px] z-40 bg-ink border-b border-divider">
        <div className="flex px-4 gap-8 overflow-x-auto no-scrollbar">
          <Link
            ...
            className={`flex flex-col items-center justify-center border-b-[3px] pb-3 min-w-fit ${isActive("topics") ? "border-b-primary text-paper" : "border-b-transparent text-tertiary hover:text-primary transition-colors"}`}
          >
          ...
          <Link
            ...
            className={`flex flex-col items-center justify-center border-b-[3px] pb-3 min-w-fit ${isActive("people") ? "border-b-primary text-paper" : "border-b-transparent text-tertiary hover:text-primary transition-colors"}`}
          >
            <p className="text-sm font-bold leading-normal tracking-tight">
              People
            </p>
          ...
          <Link
            href="/explore?tab=quoted"
            className={`flex flex-col items-center justify-center border-b-[3px] pb-3 min-w-fit ${isActive("quoted") ? "border-b-primary text-paper" : "border-b-transparent text-tertiary hover:text-primary transition-colors"}`}
          >
            <p className="text-sm font-bold leading-normal tracking-tight">
              Quoted Now
            </p>
          ...
          <Link
            href="/explore?tab=deep-dives"
            className={`flex flex-col items-center justify-center border-b-[3px] pb-3 min-w-fit ${isActive("deep-dives") ? "border-b-primary text-paper" : "border-b-transparent text-tertiary hover:text-primary transition-colors"}`}
          >
            <p className="text-sm font-bold leading-normal tracking-tight">
              Deep Dives
            </p>
