...
function VerifyContent() {
  ...
  useEffect(() => {
    ...
    queueMicrotask(() => verify(email, token));
  }, [searchParams, verify, hasValidParams, token, email]);
      ...
      <div className="min-h-screen bg-ink flex items-center justify-center px-6 relative overflow-hidden">
        ...
        <div className="w-full max-w-sm text-center relative z-10">
          <div className="space-y-6">
            <div className="w-16 h-16 bg-red-500/10 rounded-full flex items-center justify-center mx-auto border border-red-500/20 shadow-lg shadow-red-500/10">
              <svg
            ...
            <p className="text-secondary">Invalid verification link.</p>
            <Link
              href="/sign-in"
              className="inline-block px-8 py-3 bg-white/5 border border-white/10 text-paper font-semibold rounded-full hover:bg-white/10 transition-colors"
            >
              Return to sign in
            </Link>
          </div>
      ...
      <div className="w-full max-w-sm text-center relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        {status === "success" && (
          <div className="space-y-6">
            ...
            <p className="text-secondary">
              Redirecting you to your home feed...
            </p>
          </div>
        )}
...
export default function VerifyPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-ink flex items-center justify-center text-paper text-lg font-medium">
          Loading...
        </div>
      }
    >
