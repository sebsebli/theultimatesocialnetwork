      ...
      return this.props.fallback || (
        <div className="min-h-screen bg-ink flex items-center justify-center px-6 relative overflow-hidden">
          ...
          <div className="text-center relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="text-3xl font-bold text-paper mb-3 tracking-tight">Something went wrong</h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <Link href="/" className="px-8 py-3 text-secondary hover:text-paper transition-colors font-medium">
                Back to home
              </Link>
            </div>
          </div>
