    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-ink/90 backdrop-blur-lg border-t border-divider z-50 lg:hidden">
      <div className="max-w-[680px] mx-auto px-6 h-16 flex items-center justify-between">
        ...
        >
          ...
          <span className={`text-[10px] font-bold uppercase tracking-widest mt-1 transition-opacity ${isActive('/home') ? 'opacity-100' : 'opacity-0'}`}>Home</span>
        </Link>
        <Link
          href="/explore"
          className={`flex flex-col items-center justify-center w-12 h-full transition-all duration-200 ${
        ...
        >
          ...
          <span className={`text-[10px] font-bold uppercase tracking-widest mt-1 transition-opacity ${isActive('/explore') ? 'opacity-100' : 'opacity-0'}`}>Explore</span>
        </Link>
        <Link
          href="/compose"
        ...
        >
          ...
          <span className={`text-[10px] font-bold uppercase tracking-widest mt-1 transition-opacity ${isActive('/inbox') ? 'opacity-100' : 'opacity-0'}`}>Inbox</span>
        </Link>
        <Link
          href="/user/dev"
          className={`flex flex-col items-center justify-center w-12 h-full transition-all duration-200 ${
        ...
        >
          ...
          <span className={`text-[10px] font-bold uppercase tracking-widest mt-1 transition-opacity ${isActive('/user') ? 'opacity-100' : 'opacity-0'}`}>Profile</span>
        </Link>
      </div>
    </nav>
  );
